...
def mpi_wf():
    launchpad = setup()
    lp_str    = str(launchpad)

    fworker_1 = FWorker(name="mpi_2_fworker", category="n2")
    ...
    qadapter_2 = CommonAdapter(
        q_type = "SLURM",
        rocket_launch=f"rlaunch --json -l '{lp_str}' -w '{fw_str_2}' singleshot",
        constraint="gpu",
        account="nstaff",
        walltime="'00:02:00'",
        qos="regular",
    ...
    rapidfire(launchpad, fworker_2, qadapter_2, sleep_time=60, reserve=True)
